...
function pageOne () {
    ...
    //         console.log("test")
    //         if (event.target.textContent === "2. booleans") {
    //             pageTwo();
    //         } else {
    //             secondsLeft --;
    //             pageTwo();
    ...
    document.querySelector("#questionFour").addEventListener("click", function(event) {
        console.log(event.target)
        event.stopPropagation();
        secondsLeft -- ;
        pageTwo();
...
function pageFive () {
    ...
    .forEach(li => {
        li.addEventListener("click", function(event) {
            console.log("test")
            if (event.target.textContent === "3. for loops") {
                pageTwo();
            } else {
                secondsLeft --;
                pageTwo();
...
function finalScore () {
    ...
    document.querySelector("#answers").innerHTML= "Enter initials: " ;
