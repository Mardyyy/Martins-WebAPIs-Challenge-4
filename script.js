...
// code create form: https://www.freecodecamp.org/news/how-to-submit-a-form-with-javascript/#:~:text=To%20submit%20a%20form%20using,if%20any%20data%20is%20submitted).
...
function initialsForm () {
    ...
    formId.addEventListener("submit", (e) => {
        ...
        if (initials.value == "" ) {
            alert("Ensure you input your initials.");
        } else {
            highScore()
        };
    });
